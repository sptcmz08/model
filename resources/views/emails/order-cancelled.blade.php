                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:4px; overflow:hidden;">
                    ...
                    <tr>
                        <td align="center" style="padding: 10px 40px;">
                            ...
                            <div style="font-size:14px; color:#777; margin-top:4px;">your order has been cancelled.</div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center" style="padding: 20px 40px 30px;">
                            <div style="font-size:28px; font-weight:bold; color:#111;">Order Cancelled</div>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="padding-bottom:10px;">
                                        ...
                                        <div style="font-size:14px; color:#333;">${{ number_format($order->total, 2) }}</div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div style="font-size:12px; color:#999;">Reason:</div>
                    ...
                    <tr>
                        <td align="center" style="padding: 25px 40px;">
                            <div style="font-size:13px; color:#999;">If you have questions, please contact us at nattawutkongyod@hotmail.com</div>
                        </td>
                    </tr>

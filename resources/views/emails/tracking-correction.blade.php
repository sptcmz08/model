                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:4px; overflow:hidden;">
                    ...
                    <tr>
                        <td align="center" style="padding: 10px 40px;">
                            ...
                            <div style="font-size:14px; color:#777; margin-top:4px;">your tracking number has been corrected.</div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center" style="padding: 20px 40px 30px;">
                            <div style="font-size:28px; font-weight:bold; color:#111;">Tracking Correction</div>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="padding-bottom:12px;">
                                        <div style="font-size:12px; color:#999;">Previous (incorrect):</div>
                                        <div style="font-size:14px; color:#cc0000; text-decoration:line-through;">{{ $oldTracking }}</div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div style="font-size:12px; color:#999;">Correct tracking number:</div>
                    ...
                    <tr>
                        <td align="center" style="padding: 25px 40px;">
                            <div style="font-size:13px; color:#999;">We apologize for any inconvenience. Please use the new tracking number above.</div>
                        </td>
                    </tr>

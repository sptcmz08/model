                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:4px; overflow:hidden;">
                    ...
                    <tr>
                        <td align="center" style="padding: 10px 40px;">
                            ...
                            <div style="font-size:14px; color:#777; margin-top:4px;">thank you for your order.</div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="center" style="padding: 20px 40px 30px;">
                            <div style="font-size:28px; font-weight:bold; color:#111;">Order Confirmation</div>
                    ...
                    <tr>
                        <td style="padding: 20px 40px;">
                            <div style="font-size:12px; color:#999; text-transform:uppercase; letter-spacing:1px; margin-bottom:10px;">Order information:</div>
                    ...
                    <tr>
                        <td style="padding: 20px 40px;">
                            <div style="font-size:12px; color:#999; text-transform:uppercase; letter-spacing:1px; margin-bottom:10px;">Your order:</div>
                    ...
                    <tr>
                        <td style="padding: 0 40px 20px;">
                            <table width="100%" cellpadding="0" cellspacing="0">
                                ...
                                <tr>
                                    <td style="padding:10px 10px 6px; font-size:16px; font-weight:bold; color:#333; border-top:1px solid #eee;">Total</td>
                    ...
                    <tr>
                        <td align="center" style="padding: 25px 40px;">
                            <div style="font-size:13px; color:#999;">We will notify you when your order ships.</div>
                        </td>
                    </tr>
